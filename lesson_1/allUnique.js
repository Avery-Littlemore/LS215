...
// The function should return true if, and only if, all characters in the string are unique. We should 
// ignore multiple spaces and case differences; focus instead on the non-space characters without regard to case.
